...
const team = [
  { name: 'Rahul Sharma', role: 'Founder & CEO', experience: '15+ Years', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80', speciality: 'Commercial Leasing' },
